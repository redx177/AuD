...
public class TreeTest {
	...
	@Test
	public void testBalanceWithEvenElements() {
		Tree tree = new Tree(5);
		List<Integer> is = new ArrayList<Integer>();
		is.add(4);
		is.add(3);
		...
		Assert.assertEquals(4,tree.getLeft().getData());
		Assert.assertEquals(3,tree.getLeft().getLeft().getData());
		Assert.assertEquals(5,tree.getLeft().getRight().getData());
		Assert.assertEquals(12,tree.getRight().getData());
		Assert.assertEquals(10,tree.getRight().getLeft().getData());
		Assert.assertEquals(15,tree.getRight().getRight().getData());
		Assert.assertEquals(17,tree.getRight().getRight().getRight().getData());
	}

	@Test
	public void testBalanceWithOddElementsLeftist() {
		...
		Assert.assertEquals(4,tree.getLeft().getData());
		Assert.assertEquals(3,tree.getLeft().getLeft().getData());
		Assert.assertEquals(6,tree.getLeft().getRight().getData());
		Assert.assertEquals(7,tree.getLeft().getRight().getRight().getData());
		Assert.assertEquals(12,tree.getRight().getData());
		Assert.assertEquals(10,tree.getRight().getLeft().getData());
		Assert.assertEquals(15,tree.getRight().getRight().getData());
		Assert.assertEquals(17,tree.getRight().getRight().getRight().getData());
